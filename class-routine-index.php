                    ...
                    <div class="col-md-12 mt-1 color">
                        <div class="row">
                            ...
                            <div class="col-md-6 search-bar">
                                <div class="row">
                                    <div class="col-sm-4">
                                    <input class="form-control" type="text" placeholder="# Teacher Name" aria-label="Search" id="mysearch">    
                                    </div>
                                    <div class="col-sm-4">
                                    <input class="form-control" type="text" placeholder="# Time" aria-label="Search" id="mysearch">    
                                    </div>
                                    <div class="col-sm-4">
