                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <h4 class="blue">
                                <span class="middle">John Wick</span>
                            </h4>
                            <hr>
                            <a href="#" class="btn btn-primary hidden-print float-right ml-2" onclick="myFunctionDownload()">
                            ...
                            <div class="profile-user-info">
                                ...
                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Goverment ID: </div>
                                ...
                                <div class="profile-info-row">
                                    <div class="profile-info-name">Teacher Type: </div>
